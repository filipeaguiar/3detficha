        ...
        <div className="editor-card" style={{ marginBottom: '1.5rem' }}>
          ...
          {currentArchetype && (
            <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginTop: '0.6rem' }}>
              ...
              {currentArchetype.traits.length > 0 && <EditorMetaLine label="Traços:" value={currentArchetype.traits.join(', ')} />}
              {currentArchetype.grantedAdvantages && currentArchetype.grantedAdvantages.length > 0 && <EditorMetaLine label="Vantagens base:" value={currentArchetype.grantedAdvantages.join(', ')} />}
              {currentArchetype.grantedDisadvantages && currentArchetype.grantedDisadvantages.length > 0 && <EditorMetaLine label="Desvantagens base:" value={currentArchetype.grantedDisadvantages.join(', ')} />}
              {currentArchetype.notes && currentArchetype.notes.length > 0 && <EditorMetaLine label="Notas:" value={currentArchetype.notes.join(' • ')} />}
              {currentArchetype.unsupportedNotes && currentArchetype.unsupportedNotes.length > 0 && <EditorMetaLine tone="warning" label="Manual/Narrador:" value={currentArchetype.unsupportedNotes.join(' • ')} />}
        ...
        <div className="editor-card" style={{ marginBottom: '1.5rem' }}>
          ...
          {currentKit ? (
            <div className="kit-selected-preview" onClick={() => setIsKitSelectModalOpen(true)} title="Clique para trocar de kit">
              ...
              {currentKit.notes && currentKit.notes.length > 0 && <EditorMetaLine label="Notas:" value={currentKit.notes.join(' • ')} marginTop="4px" />}
              {currentKit.unsupportedNotes && currentKit.unsupportedNotes.length > 0 && <EditorMetaLine tone="warning" label="Manual/Narrador:" value={currentKit.unsupportedNotes.join(' • ')} marginTop="4px" />}
