...
export const REMAINING_TECHNIQUES: TechniqueCatalogEntry[] = [
  ...
  base({
    ...
    requirements: { skills: ['saber'], advantages: ['maestria'] }, costValue: 2, costResource: 'PM', attribute: 'habilidade', gameplayPattern: 'fixed-modifier',
  ...
  base({
    ...
    requirements: { attributes: { resistencia: 2 }, skills: ['luta'] }, duration: 'scene', attribute: 'any', gameplayPattern: 'cycling-variant',
    variants: [1, 2, 3, 4, 5].map((rank) => ({ id: `nivel_${rank}`, label: `+${rank} em P/H/R`, costValue: rank * 5, costResource: 'PM', note: `Concede +${rank} em P, H e R; recursos não mudam. Respeite o limite da Resistência original ou +5.` })),
  ...
  base({
    ...
    requirements: { anyAttributeMin: 4, skills: ['luta'] }, xpCost: 20, xpCategory: 'legendary', costValue: 15, costResource: 'PM', duration: 'scene', attribute: 'poder', extraDice: 1, autoCrit: true, gameplayPattern: 'temporary-package',
  ...
  base({
    ...
    requirements: { anyAttributeMin: 4, skills: ['luta'] }, xpCost: 20, xpCategory: 'legendary', costValue: 15, costResource: 'PM', duration: 'scene', attribute: 'habilidade', extraDice: 1, autoCrit: true, gameplayPattern: 'temporary-package',
  ...
  base({
    ...
    requirements: { anyAttributeMin: 4, skills: ['luta'] }, xpCost: 20, xpCategory: 'legendary', costValue: 15, costResource: 'PM', duration: 'scene', attribute: 'resistencia', extraDice: 1, autoCrit: true, gameplayPattern: 'temporary-package',
  ...
  base({
    ...
    requirements: { attributes: { habilidade: 6 }, techniques: ['megalon'] }, xpCost: 20, xpCategory: 'legendary', duration: 'scene', gameplayPattern: 'cycling-variant',
    variants: [
      { id: 'uma_escala', label: '+1 Escala', costValue: 25, costResource: 'PM', note: 'Eleva o alvo uma escala; consequências de escala são resolvidas em mesa.' },
      { id: 'duas_escalas', label: '+2 Escalas', costValue: 50, costResource: 'PM', note: 'Eleva o alvo duas escalas; consequências de escala são resolvidas em mesa.' },
  ...
  base({
    ...
    requirements: { attributes: { habilidade: 5 }, advantages: ['maestria'] }, xpCost: 20, xpCategory: 'legendary', costValue: 5, costResource: 'PM', duration: 'scene', attribute: 'any', gameplayPattern: 'temporary-package',
  ...
  base({
    ...
    requirements: { attributes: { poder: 4 }, advantages: ['maestria'] }, xpCost: 20, xpCategory: 'legendary', duration: 'scene', attribute: 'poder', gameplayPattern: 'persistent-assisted',
  ...
  base({
    ...
    requirements: { attributes: { habilidade: 5 }, advantages: ['maestria'] }, xpCost: 20, xpCategory: 'legendary', gameplayPattern: 'narrative',
