...
const LEGACY_ACTION_RULES: Record<string, Partial<RollBonus>> = {
  ...
  'Ataque Especial (Área)': { actionScope: 'attack', effectKey: 'ataque_especial_area', originAdvantageId: 'ataque_especial::area', automationLevel: 'assisted' },
  'Ataque Especial (Distante)': { actionScope: 'attack', effectKey: 'ataque_especial_distante', originAdvantageId: 'ataque_especial::distante', automationLevel: 'assisted' },
  'Ataque Especial (Amplo)': { actionScope: 'attack', effectKey: 'ataque_especial_amplo', originAdvantageId: 'ataque_especial::amplo', automationLevel: 'assisted' },
  'Ataque Especial (Penetrante)': { actionScope: 'attack', effectKey: 'ataque_especial_penetrante', originAdvantageId: 'ataque_especial::penetrante', automationLevel: 'assisted' },
  ...
  'Defesa Especial (Cobertura)': { actionScope: 'defense', effectKey: 'defesa_especial_cobertura', originAdvantageId: 'defesa_especial::cobertura', automationLevel: 'assisted' },
  'Defesa Especial (Reflexão)': { actionScope: 'defense', effectKey: 'defesa_especial_reflexao', originAdvantageId: 'defesa_especial::reflexao', automationLevel: 'assisted' },
